...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_AsyncETVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(global::IAsyncStateMachineAdapter.Adaptor)};
            if (genericMethods.TryGetValue("Start", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(global::IAsyncStateMachineAdapter.Adaptor).MakeByRefType()))
                    {
            ...
            args = new Type[]{typeof(ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter), typeof(global::IAsyncStateMachineAdapter.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineAdapter.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ETModel.ETTask.Awaiter), typeof(global::IAsyncStateMachineAdapter.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineAdapter.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ETModel.ETTask<ETModel.IResponse>.Awaiter), typeof(global::IAsyncStateMachineAdapter.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask<ETModel.IResponse>.Awaiter).MakeByRefType(), typeof(global::IAsyncStateMachineAdapter.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::IAsyncStateMachineAdapter.Adaptor @stateMachine = (global::IAsyncStateMachineAdapter.Adaptor)typeof(global::IAsyncStateMachineAdapter.Adaptor).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as global::IAsyncStateMachineAdapter.Adaptor[];
        ...
        static StackObject* AwaitUnsafeOnCompleted_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter @awaiter = (ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter)typeof(ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.AsyncETVoidMethodBuilder instance_of_this_method = (ETModel.AsyncETVoidMethodBuilder)typeof(ETModel.AsyncETVoidMethodBuilder).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter, global::IAsyncStateMachineAdapter.Adaptor>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETTask<global::IMessageAdapter.Adaptor>.Awaiter[];
        ...
        static StackObject* AwaitUnsafeOnCompleted_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask.Awaiter, global::IAsyncStateMachineAdapter.Adaptor>(ref @awaiter, ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask<ETModel.IResponse>.Awaiter, global::IAsyncStateMachineAdapter.Adaptor>(ref @awaiter, ref @stateMachine);
